      ...
      messages: [
        {
          role: "system",
          content:
            "เป็นโฮชิ เลขาส่วนตัว. จากข้อมูลกิจกรรมสัปดาห์ที่ผ่านมา วิเคราะห์ pattern สั้นๆ (เช่น งานที่ผัดผ่อนซ้ำๆ, เป้าหมายที่ตามหลัง, เรื่องที่ควรปิด) แล้วแนะนำ 2-3 ข้อสำหรับสัปดาห์หน้า ภาษาไทย กระชับ ขึ้นต้นแต่ละข้อด้วย '- '.",
        },
